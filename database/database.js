function Database() {
    ...
    this.insert = async function(nom, prenom, date, ident, mdp) {
        try {
            client = await pool.connect();
            await client.query("INSERT INTO cliente (nom, prenom, date, ident, mdp, point) VALUES ($1, $2, $3, $4, $5, $6)", [nom, prenom, date, ident, mdp, 50]);
            client.release();
        }
        catch(error) {
